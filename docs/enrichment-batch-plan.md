...
> 狀態：批 1–3 全部完成（2026-08-29）。24 個 Unit、2,451 字的
> 字表匯入與 enrichment 全數上線，全書 32 Units 齊備。
> 批 1：`1edbbfa`/`5d56430`；批 2：`260a876`/`a5430b2`；
> 批 3：`4504bc0`/`2a96ffc`。
...
- **批 1：Unit 19–32**（14 個 Unit，1,733 字）✅ 2026-08-29 完成
  - 實際 1,724 字：U32 workbook 有 9 個同字跨頁重複列，importer 改為
    保留首筆並警告，故 U32 為 239 字（非 248）。
- **批 2：Unit 1–5**（5 個 Unit，332 字）✅ 2026-08-29 完成
  - 實際 331 字（workbook 實算 102+38+93+79+19）。
- **批 3：Unit 6–10**（5 個 Unit，396 字）✅ 2026-08-29 完成
